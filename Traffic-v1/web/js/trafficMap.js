...
(function () {
    ...
    (function () {
        ...
        baidu.dom.addClass = function (element, className) {
            element = baidu.dom.g(element);//获取目标元素的html
            ////字符串切割成数组 /\s+/匹配任何空白字符， 与array。join("")方法相反
        ...
        /**
         * @namespace baidu.platform 鍒ゆ柇骞冲彴绫诲瀷鍜岀壒鎬х殑灞炴€с€�
         */
        baidu.platform = baidu.platform || {};

        /**
         * 鍒ゆ柇鏄惁涓篿phone骞冲彴
         * @property iphone 鏄惁涓篿phone骞冲彴
        ...
        /**
         * 鍒ゆ柇鏄惁涓篴ndroid骞冲彴
         * @property android 鏄惁涓篴ndroid骞冲彴
